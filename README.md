...
チーム：観世音菩薩
コンセプト：「暴食」は煩悩。代償は「苦悩」。
[cite_start]キャッチコピー：食べるのは煩悩、ハゲるのは罰。カロリーという業を、歩数という徳で焼き払え。[cite: 202, 203]
...
- [cite_start]**VSCode**: コードエディタ [cite: 281]
- [cite_start]**Git**: バージョン管理 [cite: 281]

### 📱 フロントエンド (Frontend)

- [cite_start]**Flutter SDK**: クロスプラットフォーム開発フレームワーク [cite: 123, 166]
- [cite_start]**Dart**: 開発言語 [cite: 166]
- [cite_start]**Android Studio**: Androidエミュレータ・ビルド用 [cite: 281]
- [cite_start]**pedometer**: 歩数取得用ライブラリ [cite: 170]
- [cite_start]**Google Fit / Apple Health**: ヘルスケアデータ連携

### ⚙️ バックエンド (Backend)

- [cite_start]**Java (JDK)**: 開発言語 [cite: 123]
- [cite_start]**Spring Boot**: Webフレームワーク [cite: 123, 168]
- [cite_start]**Firebase**: データベース (Firestore) および認証 [cite: 168, 280]

### 🤖 AI・API (External Services)

- [cite_start]**Gemini API**: 画像解析・判定ロジック用
- [cite_start]**OpenAI API**: 画像生成用 (DALL-E等) [cite: 125, 170]
